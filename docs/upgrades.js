...
(function (root) {
  ...
  root.UPGRADE_TREE = {
    ...
    S13a:  { tier:13, name:'Hyperwarp',        stats:{ boostCd:600, maxSpd:2.0, thrust:0.06 },           next:['S14a','S14b'] },
    S13b:  { tier:13, name:'Nebula Drift',     stats:{ maxSpd:2.5,  rotate:0.012, drag:0.005 },          next:['S14a','S14b'] },
    ...
    F13a:  { tier:13, name:'Hellfire',         stats:{ shootCd:40,  bulletDmg:2 },                       next:['F14a','F14b'] },
    F13b:  { tier:13, name:'Nova Cannon',      stats:{ maxBullets:1, bulletDmg:3 },                      next:['F14a','F14b'] },
    ...
    T13a:  { tier:13, name:'Fortress II',      stats:{ health:4, dmgReduce:0.06 },                       next:['T14a','T14b'] },
    T13b:  { tier:13, name:'Living Armor',     stats:{ health:3, regenRate:3, dmgReduce:0.04 },          next:['T14a','T14b'] },
    ...
    D13a:  { tier:13, name:'Hive God',         stats:{ maxBullets:1, shootCd:40 },                       next:['D14a','D14b'] },
    D13b:  { tier:13, name:'Chaos Storm',      stats:{ shootCd:40, bulletDmg:2 },                        next:['D14a','D14b'] },
    ...
    E13a:  { tier:13, name:'Tachyon Lance',    stats:{ bulletSpd:5, shootCd:30 },                        next:['E14a','E14b'] },
    E13b:  { tier:13, name:'Void Bolt',        stats:{ bulletDmg:4, bulletSpd:2 },                       next:['E14a','E14b'] },
